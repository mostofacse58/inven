...
<div class="row">
    ...
    <div class="box box-info">
      <!-- /.box-header -->
    <form class="form-horizontal" action="https://vos.vlmbd.com/common/ipurchase/save" method="POST" enctype="multipart/form-data" onsubmit="return formsubmit();">
         <div class="box-body">
       ...
       <div class="col-sm-2">
        ...
        <label class="col-sm-2 control-label">File No<span style="color:red;">  </span></label>
          <div class="col-sm-3">
            ...
            <label class="col-sm-1 control-label">Invoice No<span style="color:red;">  </span></label>
          <div class="col-sm-2">
