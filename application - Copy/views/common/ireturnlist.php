...
<a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>common/ireturn/add">
...
Add Return
        ...
        <!-- /.box-header -->
    <div class="box-body">
      <form class="form-horizontal" action="<?php echo base_url();?>common/ireturn/lists" method="GET" enctype="multipart/form-data">
        <div class="form-group">
          ...
          <a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>common/ireturn/lists">All</a>
        </div>
        </div>
         <!-- /.box-body -->
      </form>
...
$(".delete").click(function(e){
  ...
  location.href="<?php echo base_url();?>common/ireturn/delete/"+rowId;
}else{
  return false;
}
});
