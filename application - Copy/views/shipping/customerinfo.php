...
<div class="box box-info">
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>shipping/customer/save<?php if(isset($info)) echo "/$info->id"; ?>" method="POST" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-2 control-label">Customer Name<span style="color:red;">  *</span></label>
                  <div class="col-sm-5">
                    <input type="text" name="customer_name" class="form-control" placeholder="Customer Name" value="<?php if(isset($info->customer_name)) echo $info->customer_name; else echo set_value('customer_name'); ?>" autofocus>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" name="address" class="form-control" placeholder="Address" value="<?php if(isset($info->address)) echo $info->address; else echo set_value('address'); ?>">
                      ...
                      foreach($list as $row):
                          ...
                          <tr>
                              ...
                              <td style="text-align:center">
                                <a class="btn btn-success" href="<?php echo base_url()?>shipping/customer/edit/<?php echo $row->id;?>"><i class="fa fa-edit tiny-icon"></i></a>
                                &nbsp;&nbsp;&nbsp;&nbsp;                                        
...
$(".delete").click(function(e){
  ...
  $.ajax({
   type:"GET",
   url:"<?php echo base_url();?>shipping/customer/checkDelete/"+rowId,
     success:function(data){
      if(data=="EXISTS"){
        $("#deleteMessage").modal("show");
      }else{
        location.href="<?php echo base_url();?>shipping/customer/delete/"+rowId;
     }
},
error:function(){
  console.log("failed");
