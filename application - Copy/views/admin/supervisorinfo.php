...
<div class="box box-info">
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>supervisor/save<?php if(isset($info)) echo "/$info->supervisor_id"; ?>" method="POST" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-2 control-label">Name<span style="color:red;">  *</span></label>
                  <div class="col-sm-3">
                    <input type="text" name="supervisor_name" class="form-control" placeholder="Supervisor Name" value="<?php if(isset($info->supervisor_name)) echo $info->supervisor_name; else echo set_value('supervisor_name'); ?>" autofocus>
                   <span class="error-msg"><?php echo form_error("supervisor_name");?></span>
                  </div>
                      ...
                      foreach($list as $row):
                          ...
                          <tr>
                              ...
                              <td style="text-align:center">
                                <a class="btn btn-success" href="<?php echo base_url()?>supervisor/edit/<?php echo $row->supervisor_id;?>"><i class="fa fa-edit tiny-icon"></i></a>
                                &nbsp;&nbsp;&nbsp;&nbsp;                                        
                          <a href="#" class="btn btn-danger delete" data-pid="<?php echo $row->supervisor_id;?>"><i class="fa fa-trash-o tiny-icon"></i></a>
                              </td>
                          </tr>
                      <?php
                      endforeach;
...
$(".delete").click(function(e){
  job=confirm("Are you sure you want to delete this Supervisor?");
   if(job==true){
  e.preventDefault();
  ...
  $.ajax({
   type:"GET",
   url:"<?php echo base_url();?>supervisor/checkDelete 删除/"+rowId,
     success:function(data){
      if(data=="EXISTS"){
        $("#alertMessageHTML").html("Sorry, this information can't be deleted.!!");
        $("#alertMessagemodal").modal("show");
      }else{
        location.href="<?php echo base_url();?>supervisor/delete/"+rowId;
     }
},
error:function(){
  console.log("failed");
