...
<div class="box-footer">
   <div class="col-sm-6">
    <a href="<?php echo base_url(); ?>gatep/approval/lists" class="btn btn-info"> <i class="fa fa-arrow-circle-o-left" aria-hidden="true"></i> Back</a>
 ...
 <div class="col-sm-6">
  ...
  <a href="<?php echo base_url(); ?>gatep/approval/approved/<?php echo $info->gatepass_id; ?>" class="btn btn-info"> 
