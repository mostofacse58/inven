...
<a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>gatep/checkin/searchForm">
...
Scan Code
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form class="form-horizontal" action="<?php echo base_url();?>gatep/checkin/lists" method="GET" enctype="multipart/form-data">
                ...
                <div class="col-sm-1">
                  <a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>gatep/checkin/lists">All</a>
                </div>
                </div>
              </form>
          ...
          if($list&&!empty($list)): $i=1;
            ...
            <td style="text-align:center">
              <span class="btn btn-xs btn-<?php echo ($row->gatepass_status==5)?"danger":"success";?>">
                  <?php 
                  if($row->gatepass_status==1) echo "Draft";
                  elseif($row->gatepass_status==5) echo "Pending";
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu pull-right" role="menu">
                      <li><a href="<?php echo base_url()?>gatep/checkin/view/<?php echo $row->gatepass_id;?>"><i class="fa ffa fa-eye tiny-icon"></i>View</a></li>
                       <?php if($row->gatepass_status==5){  ?>
                     <li><a href="<?php echo base_url()?>gatep/checkin/viewapproved/<?php echo $row->gatepass_id;?>"><i class="fa fa-arrow-circle-right tiny-icon"></i>View & Checkin</a></li>
                    <?php } ?>
                    </ul>
                </div>
                </td>
