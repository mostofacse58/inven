...
var url1="<?php echo base_url(); ?>gatep/gatepassreceive/lists";
...
<div class="widget-control pull-right">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form class="form-horizontal" action="<?php echo base_url();?>gatep/approval/lists" method="GET" enctype="multipart/form-data">
                ...
                <div class="col-sm-1">
                  <a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>gatep/approval/lists">All</a>
                </div>
                </div>
              </form>
          ...
          if($list&&!empty($list)): $i=1;
            ...
            <td style="text-align:center">
              <span class="btn btn-xs btn-<?php echo ($row->gatepass_status==6)?"danger":"success";?>">
                 <?php 
                  ...
                  elseif($row->gatepass_status==6) echo "Pending";
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu pull-right" role="menu">
                      <li><a href="<?php echo base_url()?>gatep/gatepassreceive/view/<?php echo $row->gatepass_id;?>"><i class="fa ffa fa-eye tiny-icon"></i>View</a></li>
                       <?php if($row->gatepass_status==6){  ?>
                     <li><a href="<?php echo base_url()?>gatep/gatepassreceive/viewreceived/<?php echo $row->gatepass_id;?>">
                      <i class="fa fa-arrow-circle-right tiny-icon"></i>View & Receive</a></li>
                      <li>  <a href="#" data-pid="<?php echo $row->gatepass_id; ?>" class="reject"><i class="fa fa-ban tiny-icon"></i>Return</a></li>
                    <?php } ?>
                    </ul>
                </div>
                </td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title text-primary" id="myModalLabel"> Return Note</h4>
      </div>
      <div class="modal-body">
        <form class="form-horizontal" id="formId" method="POST" action="<?php echo base_url()?>gatep/gatepassreceive/returns">
          <div class="form-group">
            <label class="col-sm-4 control-label">Return Note </label>
            <div class="col-sm-7">
              <textarea class="form-control" name="reject_note" rows="4" id="reject_note" placeholder="Return Note"></textarea> 
