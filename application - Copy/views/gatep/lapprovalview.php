...
<div class="box-footer">
   <div class="col-sm-6">
    <a href="<?php echo base_url(); ?>gatep/lapproval/lists" class="btn btn-info"> <i class="fa fa-arrow-circle-o-left" aria-hidden="true"></i> Back</a>
   <button class="btn btn-info prints"><i class="fa fa-print" ></i> Print</button>
 </div>
 <?php if($info->approved_by2==NULL){  ?>
 <div class="col-sm-6">
  <a href="<?php echo base_url(); ?>gatep/lapproval/approved/<?php echo $info->gatepass_id; ?>" class="btn btn-info"> 
