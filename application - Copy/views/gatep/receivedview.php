  ...
  <style>
    ...
    @media print{
    .print{ display:none;}
    .gatepassreceive_panel{ display:none;}
...
<div class="box-footer">
   <div class="col-sm-6">
    <a href="<?php echo base_url(); ?>gatep/gatepassreceive/lists" class="btn btn-info"> <i class="fa fa-arrow-circle-o-left" aria-hidden="true"></i> Back</a>
   <button class="btn btn-info prints"><i class="fa fa-print" ></i> Print</button>
 </div>
 <?php if($info->gatepass_status==6){  ?>
 <div class="col-sm-6">
  <a href="#" class="btn btn-danger reject" data-pid="<?php echo $info->gatepass_id; ?>" ><i class="fa fa-ban tiny-icon"></i> Return</a>
  <a href="<?php echo base_url(); ?>gatep/gatepassreceive/received/<?php echo $info->gatepass_id; ?>" class="btn btn-info"> 
      <i class="fa fa-check" aria-hidden="true"></i> Received</a>
 </div>
 <?php } ?>
  </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       <input type="hidden" name="gatepass_id"  id="gatepass_id" value="<?php echo $info->gatepass_id; ?>">
       </form>
      </div>
