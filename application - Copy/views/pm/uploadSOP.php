...
<div class="widget-control pull-right">
      ...
      <div class="box box-info">
        <!-- /.box-header -->
        <!-- form start -->
        <form class="form-horizontal" action="<?php echo base_url(); ?>pm/checklists/uplaoddata" method="POST" enctype="multipart/form-data" onsubmit="return formsubmit();">
      <div class="box-body">
        ...
        <label class="col-sm-2 control-label">Excel File</label>
         ...
         <div class="col-sm-4"><a href="<?php echo base_url(); ?>pm/checklists/sample" class="btn btn-info">
