...
<div class="box-footer">
   <div class="col-sm-6">
    <a href="<?php echo base_url(); ?>cc/approval/lists" class="btn btn-info"> <i class="fa fa-arrow-circle-o-left" aria-hidden="true"></i> Back</a>
   <button class="btn btn-info prints"><i class="fa fa-print" ></i> Print</button>
 </div>
 <?php if($info->courier_status==2){  ?>
 <div class="col-sm-6">
  <a href="#" class="btn btn-danger reject" data-pid="<?php echo $info->courier_id; ?>" ><i class="fa fa-ban tiny-icon"></i> Return</a>
  <a href="<?php echo base_url(); ?>cc/approval/approved/<?php echo $info->courier_id; ?>" class="btn btn-info"> 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" id="formId" method="POST" action="<?php echo base_url()?>cc/approval/returns">
