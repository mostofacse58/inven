...
<div class="row">
    <div class="col-md-12">
      ...
      <!-- /.box-header -->
    <form class="form-horizontal" action="<?php echo base_url(); ?>aformat/requisitionapp/save<?php if (isset($info)) echo "/$info->requisition_id"; ?>" method="POST" enctype="multipart/form-data" onsubmit="return formsubmit();">
         <div class="box-body">
...
<tbody>
 ...
 $id=0;
  ...
  <div class="col-sm-4"><a href="<?php echo base_url(); ?>aformat/requisitionapp/lists" class="btn btn-info">
