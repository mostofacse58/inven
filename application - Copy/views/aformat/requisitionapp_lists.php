...
<div class="widget-control pull-right">
            ...
            <!-- /.box-header -->
      <div class="box-body">
        <form class="form-horizontal" action="<?php echo base_url();?>aformat/requisitionapp/lists" method="GET" enctype="multipart/form-data">
          <div class="box-body">
            <label class="col-sm-1 control-label">
             Req. NO <span style="color:red;">  </span></label>
              ...
              <div class="col-sm-2">
                ...
                <a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>aformat/requisitionapp/lists">All</a>
            </div>
          </div>
          <!-- /.box-body -->
        </form>
        ...
        if($list&&!empty($list)): $i=1;
          ...
          <tr>
            ...
            <div class="btn-group">
              ...
              <li><a href="<?php echo base_url()?>aformat/requisitionapp/approved/<?php echo $row->requisition_id;?>">
                <i class="fa fa-arrow-circle-o-right tiny-icon"></i>
              Approve</a></li>
              <li><a href="<?php echo base_url()?>aformat/requisitionapp/rejected/<?php echo $row->requisition_id;?>">
                <i class="fa fa-arrow-circle-o-right tiny-icon"></i>
              Reject</a></li>
              <li><a href="<?php echo base_url()?>aformat/requisitionapp/returns/<?php echo $row->requisition_id;?>">
                <i class="fa fa-arrow-circle-o-right tiny-icon"></i>
              Return</a></li>
             <?php } ?>
              </ul>
