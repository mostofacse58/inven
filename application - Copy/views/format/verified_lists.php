      ...
      <div class="box-body">
        ...
        <div class="box-body">
           ...
           PI. NO <span style="color:red;">  </span></label>
            ...
            <div class="col-sm-2">
              <select class="form-control select2" required name="pi_status" id="pi_status"  onchange='this.form.submit()'>
                <option value="4"
                <?php  if(isset($pi_status)) echo 4==$pi_status? 'selected="selected"':0; else echo set_select('pi_status',4);?>>
                  Pending(<?php echo $pencount; ?>)</option>
                <option value="5"
                <?php  if(isset($pi_status)) echo 5==$pi_status? 'selected="selected"':0; else echo set_select('pi_status',5);?>>
                  Verified(<?php echo $vercount; ?>)</option>
                <option value="6"
                <?php  if(isset($pi_status)) echo 6==$pi_status? 'selected="selected"':0; else echo set_select('pi_status',6);?>>
                  Received(<?php echo $reccount; ?>)</option>
                <option value="7"
          ...
          <div class="col-sm-2">
            ...
            <a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>format/verified/lists">All</a>
        </div>
      </div>
        <!-- /.box-body -->
      </form>
      ...
      <table id="examplse1" class="table table-bordered table-striped" style="width:100%;border:#000" >
        ...
        if($list&&!empty($list)): $i=1;
          ...
          <tr>
            ...
            <span class="btn btn-xs btn-<?php echo ($row->pi_status==4||$row->pi_status==8)?"danger":"success";?>">
              <?php 
            ...
            <div class="btn-group">
              ...
              <ul class="dropdown-menu pull-right" role="menu">
                <?php if($row->pi_status==4){ ?>
                <li> <a href="<?php echo base_url()?>format/verified/viewpihtml/<?php echo $row->pi_id;?>"><i class="fa fa-eye tiny-icon"></i>View & Verify</a></li>
              <?php } ?>
