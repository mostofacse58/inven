...
<a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>wh/stockin/add">
<i class="fa fa-plus"></i>
Add 
</a>
<a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>wh/stockin/addbulk">
<i class="fa fa-plus"></i>
Uplaod Excel 
</a>
</div>
            ...
            <!-- /.box-header -->
        <div class="box-body">
          <form class="form-horizontal" action="<?php echo base_url();?>wh/stockin/lists" method="GET" enctype="multipart/form-data">
             <div class="form-group">
              <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                <span class="info-box-icon bg-red"><i class="fa fa-th"></i></span>
                <div class="info-box-content">
                <span class="info-box-text">Waiting for IN</span>
                ...
                <div class="info-box-content">
                <span class="info-box-text">Already In</span>
                <span class="info-box-number">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12" >
                  ...
                  <a href="<?php echo base_url();?>wh/stockin/dashboard" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                  </div>
                  </div>
              </div>
              <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-2">
                <select class="form-control select2"  name="status" id="status">
                  ...
                  <option value="1">Waiting for IN</option>
              ...
              <a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>wh/stockin/lists">All</a>
            </div>
          ...
          if($list&&!empty($list)): $i=$page+1;
            foreach($list as $row):
              ...
              <tr>
                ...
                <td class="text-center">
                <span class="btn btn-xs btn-<?php echo ($row->in_status==1)?"danger":"success";?>">
                  <?php 
                    if($row->in_status==1) echo "Waiting for IN";
                    elseif($row->in_status==2) echo "IN";
                    ?>
                </span></td>
                <td style="text-align:center">
                    <!-- Single button -->
                <div class="btn-group">
                    ...
                    <!-- <li> <a href="<?php echo base_url()?>wh/stockin/view/<?php echo $row->id;?>" target="_blank"> -->
                      <!-- <i class="fa fa-eye tiny-icon"></i>View</a></li> -->
                      <?php if($row->in_status==1){ ?>
                      <li> <a href="<?php echo base_url()?>wh/stockin/edit/<?php echo $row->id;?>">
                    ...
                    <?php } ?>
                  <?php } ?>
                      <!--  <li> <a href="<?php echo base_url()?>wh/stockin/returnback/<?php echo $row->id;?>">
...
$(".delete").click(function(e){
  ...
  location.href="<?php echo base_url();?>wh/stockin/delete/"+rowId;
}else{
  return false;
}
});
