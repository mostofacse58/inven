...
<div class="widget-control pull-right">
  ...
  <!-- form start -->
<form class="form-horizontal" action="<?php echo base_url(); ?>payment/budgety/save<?php if (isset($info)) echo "/$master_id"; ?>" method="POST" id="formid">
<div class="box-body">
 ...
 <div class="form-group">
  ...
  <div class="col-sm-4">
     <select class="form-control select2" name="for_month" id="for_month" style="width: 100%">
	  <option value="">Select Year</option>
	  <?php for ($m=2024;2036>$m;$m++) {  ?>
	    <option value="<?php echo $m; ?>"
	      <?php  if(isset($info)) echo $m==$info->for_month? 'selected="selected"':0; else echo set_select('for_month',$m);?>>
	      <?php echo $m; ?></option>
	    <?php } ?>
	</select>
  </div>
...
<div class="box-footer">
  <div class="col-sm-6"><a href="<?php echo base_url(); ?>payment/budgety/lists" class="btn btn-info">
