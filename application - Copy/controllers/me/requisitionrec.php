...
class Requisitionrec extends My_Controller {
    function __construct(){
        ...
        $this->load->model('me/requisitionrec_model');
     }
    ...
    function lists(){
      ...
      $config['base_url']=base_url().'me/requisitionrec/lists/';
      ...
      $data['display']='me/requisitionrec_lists';
    ...
    function delete($requisition_id=FALSE){
      ...
      redirect("me/requisitionrec/lists");
    }
////////////////////////
