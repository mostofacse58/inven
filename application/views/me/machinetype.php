...
<div class="box box-info">
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>me/machinetype/save<?php if(isset($info)) echo "/$info->machine_type_id"; ?>" method="POST" enctype="multipart/form-data">
              <div class="box-body">
                      ...
                      foreach($list as $row):
                          ...
                          <tr>
                              ...
                              <td style="text-align:center">
                                <a class="btn btn-success" href="<?php echo base_url()?>me/machinetype/edit/<?php echo $row->machine_type_id;?>"><i class="fa fa-edit tiny-icon"></i></a>
                                &nbsp;&nbsp;&nbsp;&nbsp;                                        
...
$(".delete").click(function(e){
  ...
  $.ajax({
   type:"GET",
   url:"<?php echo base_url();?>me/machinetype/checkMachinetype/"+rowId,
     success:function(data){
      if(data=="EXISTS"){
        $("#alertMessageHTML").html("Sorry, this information can't be deleted.!!");
      $("#alertMessagemodal").modal("show");
      }else{
        location.href="<?php echo base_url();?>me/machinetype/delete/"+rowId;
     }
},
error:function(){
  console.log("failed");
