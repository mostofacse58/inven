...
<a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>aformat/requisition/add">
...
Add Requisition
            ...
            <!-- /.box-header -->
      <div class="box-body">
         <form class="form-horizontal" action="<?php echo base_url();?>aformat/requisition/lists" method="GET" enctype="multipart/form-data">
          <div class="box-body">
            <label class="col-sm-1 control-label">
             Req. NO <span style="color:red;">  </span></label>
              ...
              <div class="col-sm-2">
                ...
                <a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>aformat/requisition/lists">All</a>
            </div>
          </div>
          <!-- /.box-body -->
        </form>
        ...
        if($list&&!empty($list)): $i=1;
          ...
          <tr>
            ...
            <div class="btn-group">
              ...
              <li> <a href="<?php echo base_url()?>aformat/requisition/view/<?php echo $row->requisition_id;?>" target="_blank"><i class="fa fa-eye tiny-icon"></i>View</a></li>
              <?php if($row->requisition_status==1){ ?>
              <li> <a href="<?php echo base_url()?>aformat/requisition/submit/<?php echo $row->requisition_id;?>">
                <i class="fa fa-arrow-circle-o-right tiny-icon"></i>Submit</a></li>
              <li> <a href="<?php echo base_url()?>aformat/requisition/edit/<?php echo $row->requisition_id;?>"><i class="fa fa-edit tiny-icon"></i>Edit 编辑</a></li>
...
$(".delete").click(function(e){
  ...
  location.href="<?php echo base_url();?>aformat/requisition/delete/"+rowId;
}else{
  return false;
}
});
