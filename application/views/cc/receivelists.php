...
<div class="widget-control pull-right">
        ...
        <!-- /.box-header -->
        <div class="box-body">
          <form class="form-horizontal" action="<?php echo base_url();?>cc/receive/lists" method="GET" enctype="multipart/form-data">
          ...
          <div class="col-sm-1">
            <a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>cc/receive/lists">All</a>
          </div>
          </div>
        </form>
        <div class="table-responsive table-bordered">
          ...
          if($list&&!empty($list)): $i=1;
            ...
            <td style="text-align:center">
              <span class="btn btn-xs btn-<?php echo ($row->courier_status==3)?"danger":"success";?>">
                  <?php 
                  if($row->courier_status==1) echo "Draft";
                  elseif($row->courier_status==2) echo "Pending";
                  elseif($row->courier_status==3) echo "Pending";
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu pull-right" role="menu">
                      <li><a href="<?php echo base_url()?>cc/receive/view/<?php echo $row->courier_id;?>"><i class="fa fa-eye tiny-icon"></i>View</a></li>
                      <li><a href="<?php echo base_url()?>dashboard/viewCCpdf/<?php echo $row->courier_id;?>"><i class="fa fa-file-pdf-o tiny-icon"></i>PDF</a></li>
                    <?php if($row->courier_status==3){  ?>
                     <li><a href="<?php echo base_url()?>cc/receive/receiveview/<?php echo $row->courier_id;?>">
                      <i class="fa fa-arrow-circle-right tiny-icon"></i>View & Receive</a>
                    </li>
                    <?php } ?>
                    <?php if($row->courier_status==4){  ?>
                     <li><a href="<?php echo base_url()?>cc/receive/addinform/<?php echo $row->courier_id;?>">
                      <i class="fa fa-arrow-circle-right tiny-icon"></i>Add information</a>
                    </li>
                    <li><a href="<?php echo base_url()?>cc/receive/submit/<?php echo $row->courier_id;?>"><i class="fa fa-arrow-circle-right tiny-icon"></i>Send</a></li>
                    <?php } ?>
