...
var url1="<?php echo base_url(); ?>cc/courier/lists";
...
<a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>cc/courier/add">
...
Add New
        ...
        <!-- /.box-header -->
        <div class="box-body">
          <form class="form-horizontal" action="<?php echo base_url();?>cc/courier/lists" method="GET" enctype="multipart/form-data">
          ...
          <div class="col-sm-1">
            <a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>cc/courier/lists">All</a>
          </div>
          </div>
        </form>
        <div class="table-responsive table-bordered">
          ...
          if($list&&!empty($list)): $i=1;
            ...
            <td style="text-align:center">
              <span class="btn btn-xs btn-<?php echo ($row->courier_status==2||$row->courier_status==1)?"danger":"success";?>">
                  <?php 
                  if($row->courier_status==1) echo "Draft";
                  elseif($row->courier_status==2) echo "Submit";
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu pull-right" role="menu">
                      <li><a href="<?php echo base_url()?>cc/courier/view/<?php echo $row->courier_id;?>"><i class="fa ffa fa-eye tiny-icon"></i>View</a></li>
                      <li><a href="<?php echo base_url()?>dashboard/viewCCpdf/<?php echo $row->courier_id;?>"><i class="fa fa-file-pdf-o tiny-icon"></i>PDF</a></li>
                       <?php if($row->courier_status==1){  ?>
                     <li><a href="<?php echo base_url()?>cc/courier/submit/<?php echo $row->courier_id;?>">
                      <i class="fa fa-arrow-circle-right tiny-icon"></i>Submit</a>
                    </li>
                    <?php } ?>
                      <?php if($row->courier_status==1){  ?>
                      <?php if($this->session->userdata('update')=='YES'){ ?>
                      <li>  <a href="<?php echo base_url()?>cc/courier/edit/<?php echo $row->courier_id;?>"><i class="fa fa-edit tiny-icon"></i>Edit</a>
                      </li>
                      <?php } ?>
                      <?php if($this->session->userdata('delete')=='YES'){ ?>
                      <li><a href="#" class="delete" data-pid="<?php echo $row->courier_id;?>"><i class="fa fa-trash-o tiny-icon"></i>Delete</a></li>
                    <?php } ?>
                    <?php } ?>
                    </ul>
                </div>
...
$(".delete").click(function(e){
  ...
  location.href="<?php echo base_url();?>cc/courier/delete/"+rowId;
}
});
});//jquery ends here
</script>
