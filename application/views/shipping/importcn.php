...
<div class="widget-control pull-right">
  <a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>shipping/import/addExcel">
<i class="fa fa-plus"></i>
Upload Excel
</a>
<a class="btn btn-sm btn-primary pull-right" style="margin-right:5px;" href="<?php echo base_url(); ?>shipping/import/add">
<i class="fa fa-plus"></i>
Add New
</a>
<a class="btn btn-sm btn-primary pull-right" style="margin-right:5px;" href="<?php echo base_url(); ?>shipping/import/loadExcel<?php echo $condition; ?> ">
<i class="fa fa-plus"></i>
Export Excel
</a>
        ...
        <!-- /.box-header -->
        <div class="box-body">
          <form class="form-horizontal" action="<?php echo base_url();?>shipping/import/lists" method="GET" enctype="multipart/form-data">
              ...
              <span class="btn btn-xs btn-<?php echo ($row->import_status==2||$row->import_status==1)?"danger":"success";?>">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu pull-right" role="menu">
                      <li><a href="<?php echo base_url()?>shipping/import/view/<?php echo $row->import_id;?>"><i class="fa ffa fa-eye tiny-icon"></i>View</a></li>
                   <!--    <li><a href="<?php echo base_url()?>dashboard/viewCCpdf/<?php echo $row->import_id;?>"><i class="fa fa-file-pdf-o tiny-icon"></i>PDF</a></li> -->
                       <?php if($row->import_status==1){  ?>
                     <li><a href="<?php echo base_url()?>shipping/import/submit/<?php echo $row->import_id;?>">
                      <i class="fa fa-arrow-circle-right tiny-icon"></i>Submit</a>
                    </li>
                    <?php } ?>
                      <?php if($row->import_status<=2){  ?>
                      <?php if($this->session->userdata('update')=='YES'){ ?>
                      <li>  <a href="<?php echo base_url()?>shipping/import/edit/<?php echo $row->import_id;?>"><i class="fa fa-edit tiny-icon"></i>Edit</a>
                      </li>
                      <?php }  } ?>
                      <?php if($row->import_status==1){  ?>
                      <?php if($this->session->userdata('delete')=='YES'){ ?>
                      <li><a href="#" class="delete" data-pid="<?php echo $row->import_id;?>"><i class="fa fa-trash-o tiny-icon"></i>Delete</a></li>
                    <?php } ?>
                    <?php } ?>
                    </ul>
                </div>
...
$(".delete").click(function(e){
  ...
  location.href="<?php echo base_url();?>shipping/import/delete/"+rowId;
}
});
});//jquery ends here
</script>
