...
var url1="<?php echo base_url(); ?>gatep/gatepass/lists";
...
<a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>gatep/gatepass/add">
...
Add New
        ...
        <!-- /.box-header -->
        <div class="box-body">
          <form class="form-horizontal" action="<?php echo base_url();?>gatep/gatepass/lists" method="GET" enctype="multipart/form-data">
          ...
          <div class="col-sm-1">
            <a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>gatep/gatepass/lists">All</a>
          </div>
          </div>
        </form>
        <div class="table-responsive">
          ...
          <tr>
              ...
              <th style="width:15%;text-align:center">Issue To</th>
          ...
          if($list&&!empty($list)): $i=1;
            ...
            <td style="text-align:center">
            <?php echo getGatepassType($row->gatepass_type); ?></td>
            <td style="text-align:center">
            ...
            <td style="text-align:center">
              <span class="btn btn-xs btn-<?php echo ($row->gatepass_status==2||$row->gatepass_status==1||$row->gatepass_status==8)?"danger":"success";?>">
                  <?php 
                  ...
                  elseif($row->gatepass_status==6) echo "Check-In";
                  elseif($row->gatepass_status==7) echo "Received";
                  elseif($row->gatepass_status==8) echo "Declined";
                  ?>
              </span>
              </td>
                <td style="text-align:center">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu pull-right" role="menu">
                      <li><a href="<?php echo base_url()?>gatep/gatepass/view/<?php echo $row->gatepass_id;?>"><i class="fa ffa fa-eye tiny-icon"></i>View</a></li>
                       <?php if($row->gatepass_status==1){  ?>
                     <li><a href="<?php echo base_url()?>gatep/gatepass/submit/<?php echo $row->gatepass_id;?>">
                      <i class="fa fa-arrow-circle-right tiny-icon"></i>Send</a>
                    </li>
                    <?php } ?>
                      <?php if($row->gatepass_status==1){  ?>
                      <?php if($this->session->userdata('update')=='YES'){ ?>
                      <li>  <a href="<?php echo base_url()?>gatep/gatepass/edit/<?php echo $row->gatepass_id;?>"><i class="fa fa-edit tiny-icon"></i>Edit</a>
                      </li>
                      <?php } ?>
                      <li><a href="#" class="delete" data-pid="<?php echo $row->gatepass_id;?>"><i class="fa fa-trash-o tiny-icon"></i>Delete</a></li>
                    <?php } ?>
                    <?php //if($row->gatepass_status==4&&$row->edit_status<=1&&$row->gatepass_type==3&&($this->session->userdata('department_id')==6||$this->session->userdata('department_id')==1)){  ?>
                      <li>  <a href="<?php echo base_url()?>gatep/gatepass/fedit/<?php echo $row->gatepass_id;?>"><i class="fa fa-edit tiny-icon"></i>Edit</a>
                      </li>
                      <?php //} ?>
                    </ul>
                </div>
...
$(".delete").click(function(e){
  ...
  location.href="<?php echo base_url();?>gatep/gatepass/delete/"+rowId;
}
});
});//jquery ends here
</script>
