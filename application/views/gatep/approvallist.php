...
var url1="<?php echo base_url(); ?>gatep/approval/lists";
              ...
              <span class="btn btn-xs btn-<?php echo ($row->gatepass_status==3)?"danger":"success";?>">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu pull-right" role="menu">
                      <li><a href="<?php echo base_url()?>gatep/approval/view/<?php echo $row->gatepass_id;?>"><i class="fa ffa fa-eye tiny-icon"></i>View</a></li>
                       <?php if($row->gatepass_status==3){  ?>
                     <li><a href="<?php echo base_url()?>gatep/approval/viewapproved/<?php echo $row->gatepass_id;?>">
