...
<a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>payment/applications/add">
...
<!-- /.box-header -->
<div class="box-body">
  <form class="form-horizontal" action="<?php echo base_url();?>payment/applications/lists" method="GET" enctype="multipart/form-data">
  <div class="box-body">
    ...
    <label class="col-sm-2 control-label">Application. NO </label>
      ...
      <div class="col-sm-3">
        ...
        <a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>payment/applications/lists">All</a>
    </div>
  </div>
  </div>
  <!-- /.box-body -->
...
<table id="examplse1" class="table table-bordered table-striped" style="width:100%;border:#000" >
  ...
  if($lists&&!empty($lists)): $i=$page+1;
    ...
    <tr>
      ...
      if($row->supplier_id==353) echo $row->other_name; 
      ...
      <div class="btn-group">
        ...
        <ul class="dropdown-menu pull-right" role="menu">
          <li><a href="<?php echo base_url()?>payment/applications/view/<?php echo $row->payment_id;?>">
        ...
        <?php if($row->status==1){ ?>
        <li> <a href="<?php echo base_url()?>payment/applications/submit/<?php echo $row->payment_id;?>">
          <i class="fa fa-arrow-circle-o-right tiny-icon"></i>Submit</a></li>
        <li> <a href="<?php echo base_url()?>payment/applications/edit/<?php echo $row->payment_id;?>">
          <i class="fa fa-edit tiny-icon"></i>Edit 编辑</a></li>
        <li><a href="#" class="delete" data-applicationsd="<?php echo $row->payment_id;?>">
...
$(".delete").click(function(e){
  job=confirm("Are you sure you want to delete this Inpaymention?");
   if(job==true){
  e.preventDefault();
  var rowId=$(this).data('applicationsd');
  location.href="<?php echo base_url();?>payment/applications/deletes/"+rowId;
}else{
  return false;
}
});
