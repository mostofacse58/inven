...
<!-- /.box-header -->
<div class="box-body">
  <form class="form-horizontal" action="<?php echo base_url();?>payment/paview/lists" method="GET" enctype="multipart/form-data">
  <div class="box-body">
    ...
    <label class="col-sm-2 control-label">Application. NO </label>
      ...
      <div class="col-sm-3">
        ...
        <a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>payment/paview/lists">All</a>
    </div>
  </div>
  </div>
  <!-- /.box-body -->
    ...
    <tr>
      ...
      <div class="btn-group">
        ...
        <ul class="dropdown-menu pull-right" role="menu">
          <li><a href="<?php echo base_url()?>payment/paview/view/<?php echo $row->payment_id;?>">
