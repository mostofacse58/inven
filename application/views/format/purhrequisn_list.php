...
<div class="widget-control pull-right">
  ...
  <!-- /.box-header -->
    <div class="box-body">
      <form class="form-horizontal" action="<?php echo base_url();?>format/purhrequisn/lists" method="GET" enctype="multipart/form-data">
      <div class="box-body">
        ...
        <div class="form-group">
         ...
         <label class="col-sm-1 control-label">Date</label>
          ...
          <div class="col-sm-3">
            ...
            <a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>format/purhrequisn/lists">All</a>
        </div>
      </div>
        <!-- /.box-body -->
      </form>
      ...
      <td class="text-center"><?php echo $row->user_name; ?></td>
            ...
            <ul class="dropdown-menu pull-right" role="menu">
              ...
              <li> <a href="<?php echo base_url()?>format/purhrequisn/received/<?php echo $row->pi_id;?>">
                <i class="fa fa-check tiny-icon"></i>Receive 接收</a></li>
                <li> <a  data-pid="<?php echo $row->pi_id; ?>" data-pistatus="1" class="canceled" href="#">
                <i class="fa fa-times tiny-icon"></i>Return 返回</a></li>
              ...
              <li><a href="<?php echo base_url()?>dashboard/viewpipdf/<?php echo $row->pi_id;?>" target="_blank">
               ...
               <li> <a href="<?php echo base_url()?>format/purhrequisn/viewpihtmlonly/<?php echo $row->pi_id;?>">
              <i class="fa fa-eye tiny-icon"></i>View </a></li>
              <li> <a href="<?php echo base_url()?>format/purhrequisn/erpview/<?php echo $row->pi_id;?>">
              ...
              <?php } ?>
              <?php if($row->pi_status==7){ ?>
              <li> <a href="<?php echo base_url()?>format/po/addpitowo/<?php echo $row->pi_id;?>">
                <i class="fa fa-check tiny-icon"></i>Add PO</a></li>
              <?php } ?>            
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" id="formId" method="POST" action="<?php echo base_url()?>format/purhrequisn/rejected">
          <div class="form-group">
