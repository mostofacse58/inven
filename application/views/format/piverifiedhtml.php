...
<table class="tg1" style="overflow: hidden;">
 <tr>
  ...
  <?php if($info->pi_status==4){ ?>
  <div class="col-sm-12" style="text-align: center;">
    <a class="btn btn-info canceled" data-pistatus="5" data-pid="<?php echo $info->pi_id; ?>">
    <i class="fa fa-check-circle-o tiny-icon"></i> Verify 校验</a>
...
///////////////////////////
  ...
  $(".canceled").click(function(e){
    ...
    if(pistatus==5){
      ...
      $("#myModalLabel").html("<span style='color: green;'>Verify Comment</span>");
    }else if(pistatus==8){
