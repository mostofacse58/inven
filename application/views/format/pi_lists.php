...
<!-- /.box-header -->
      <div class="box-body">
        <form class="form-horizontal" action="<?php echo base_url();?>format/pi/lists" method="GET" enctype="multipart/form-data">
        <div class="box-body">
          <label class="col-sm-1 control-label">
           PI. NO <span style="color:red;">  </span></label>
            ...
            <div class="col-sm-2">
              <select class="form-control" required name="pi_status" id="pi_status"  onchange='this.form.submit()'>
                <option value="6"
                  <?php  if(isset($pi_status)) echo 6==$pi_status? 'selected="selected"':0; else echo set_select('pi_status',6);?>>
                    Pending(<?php echo $pencount; ?>)</option>
                  <option value="7"
                  <?php  if(isset($pi_status)) echo 7==$pi_status? 'selected="selected"':0; else echo set_select('pi_status',7);?>>
          ...
          <div class="col-sm-3">
            ...
            <a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>format/pi/lists">All</a>
        </div>
      </div>
        <!-- /.box-body -->
      </form>
      ...
      <table id="examplse1" class="table table-bordered table-striped" style="width:100%;border:#000" >
        ...
        if($list&&!empty($list)): $i=1;
          ...
          <tr>
            ...
            <span class="btn btn-xs btn-<?php echo ($row->pi_status==6||$row->pi_status==8)?"danger":"success";?>">
              <?php 
                ...
                elseif($row->pi_status==6) echo "Pending";
            ...
            <div class="btn-group">
              ...
              <ul class="dropdown-menu pull-right" role="menu">
                <?php if($row->pi_status==6){ ?>
                <li> <a href="<?php echo base_url()?>format/pi/viewpihtml/<?php echo $row->pi_id;?>"><i class="fa fa-eye tiny-icon"></i>View & Approve</a></li>
              <?php } ?>
            ...
            <!--   <li> <a href="<?php echo base_url()?>format/pi/approved/<?php echo $row->pi_id;?>">
              ...
              <li> <a  data-pid="<?php echo $row->pi_id; ?>" data-pistatus="1"  class="canceled"><i class="fa fa-arrow-circle-o-right tiny-icon"></i>Return 返回</a></li>

              <li> <a  data-pid="<?php echo $row->pi_id; ?>" data-pistatus="0" class="canceled"><i class="fa fa-arrow-circle-o-right tiny-icon"></i>Reject 拒绝</a></li>
              -->
              <?php } ?>
              </ul>
            </div>
