...
href="<?php echo base_url(); ?>common/ipurchase/add">
...
Add New
            ...
            <!-- /.box-header -->
  <div class="box-body">
    <form class="form-horizontal" action="<?php echo base_url();?>common/ipurchase/lists" method="GET" enctype="multipart/form-data">
    ...
    <label class="col-sm-1 control-label">Search By </label>
        ...
        <div class="col-sm-3">
          ...
          <a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>common/ipurchase/lists">All</a>
      </div>
    </div>
        ...
        if($list&&!empty($list)): $i=$page+1;
          ...
          <tr>
            ...
            <div class="btn-group">
              ...
              <li> <a href="<?php echo base_url()?>common/ipurchase/view/<?php echo $row->purchase_id;?>" target="_blank"><i class="fa fa-eye tiny-icon"></i>View</a></li>
              <li> <a href="<?php echo base_url()?>common/ipurchase/viewpdf/<?php echo $row->purchase_id;?>" target="_blank"><i class="fa fa-eye tiny-icon"></i>PDF</a></li>
              <?php if($row->status==1){ ?>
              <li><a href="<?php echo base_url()?>common/ipurchase/submit/<?php echo $row->purchase_id;?>"><i class="fa fa-arrow-circle-o-right tiny-icon"></i>Submit</a></li>
              <?php } ?>
...
$(".delete").click(function(e){
  ...
  $.ajax({
   type:"GET",
   url:"<?php echo base_url();?>common/ipurchase/checkItemsUse/"+rowId,
     success:function(data){
      if(data=="EXISTS"){
        $("#alertMessageHTML").html("Sorry, this GRN can't be return.!!");
      $("#alertMessagemodal").modal("show");
      }else{
        location.href="<?php echo base_url();?>common/ipurchase/delete3/"+rowId;
     }
},
error:function(){
  console.log("failed");
