...
var url1="<?php echo base_url(); ?>it/maintenance/lists";
...
<a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>it/maintenance/add">
...
Add 
      ...
      <!-- /.box-header -->
      <div class="box-body">
        <form class="form-horizontal" action="<?php echo base_url();?>it/maintenance/lists" method="GET" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>it/maintenance/lists">All</a>
        </div>
        </div>
      ...
      <div class="table-responsive table-bordered">
        <table id="" class="table table-bordered table-striped" style="width:100%;border:#00" >
          ...
          <tr>
            ...
            <th style="text-align:center;width:8%">Category</th>
            <th style="width:8%">TPM/Asset Code</th>
            <th style="width:15%;">Asset Name</th>
            <th style="width:6%;text-align:center">Location</th>
            <th style="text-align:center;width:8%;">Date</th>
            <th style="text-align:center;width:6%;">Work Note</th>
            <th style="text-align:center;width:6%;">Spare Parts</th>
            <th style="text-align:center;width:6%;">Tema Member</th>
            <th style="text-align:center;width:12%;">Customer Review</th>
        ...
        if($list&&!empty($list)): $i=1;
          foreach($list as $row):
            ...
            <tr>
              ...
              <td style="text-align:center">
              <?php echo findDate($row->date);  ?></td>
              <td style="text-align:center">
                <?php echo $row->location_name; ?></td>
              <td style="text-align:center">
                <?php echo $row->work_note; ?></td>
                 <td style="text-align:center">
                <?php echo $row->spare_parts;  ?></td>
              <td style="text-align:center">
                <?php echo $row->team_member;  ?></td>
              <td style="text-align:center">
                <?php echo $row->customer_review;  ?></td>
              <td style="text-align:center">
                  <!-- Single button -->
              <div class="btn-group">
                  ...
                  <ul class="dropdown-menu pull-right" role="menu">
                    <li> <a href="<?php echo base_url()?>it/maintenance/edit/<?php echo $row->maintenance_id;?>"><i class="fa fa-edit tiny-icon"></i>Edit 编辑</a></li>
                      <?php if($this->session->userdata('delete')=='YES'){ ?>
                    <li><a href="#" class="delete" data-pid="<?php echo $row->maintenance_id;?>"><i class="fa fa-trash-o tiny-icon"></i>Delete 删除</a></li>
                  <?php } ?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" id="formId" method="POST" action="<?php echo base_url()?>it/maintenance/returndate">
...
<div class="modal fade " id="TeamModal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" id="formId1" method="POST" action="<?php echo base_url()?>it/maintenance/underService">
          <div class="form-group">
            <label class="col-sm-3 control-label">Date </label>
            <div class="col-sm-6">
       ...
       <input type="hidden" name="maintenance_id1"  id="maintenance_id1">
       </form>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" data-dismiss="modal"> Close</button>
...
$(".delete").click(function(e){
  ...
  location.href="<?php echo base_url();?>it/maintenance/delete/"+rowId;
