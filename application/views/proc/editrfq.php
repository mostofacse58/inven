...
<div class="widget-control pull-right">
   ...
   <div class="box box-info">
      <!-- /.box-header -->
    <form class="form-horizontal" action="<?php echo base_url(); ?>proc/rfq/save/<?php if(isset($info)) echo $info->rfq_id; ?>" method="post" enctype="multipart/form-data" onsubmit="return formsubmit();">
         <div class="box-body">
