<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
   class Requisitionapp extends My_Controller {
    function __construct(){
        ...
        $this->load->model('me/requisitionapp_model');
     }
    ...
    function lists(){
      ...
      $config['base_url']=base_url().'me/requisitionapp/lists/';
      ...
      $data['display']='me/requisitionapp_lists';
   ...
   function save($requisition_id=FALSE){
      ...
      redirect("me/requisitionapp/lists");
    }
