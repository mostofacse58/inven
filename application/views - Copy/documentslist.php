...
<a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>documents/add">
        ...
        if($list&&!empty($list)):$i=1;
          foreach($list as $row):
            ...
            <tr>
              ...
              <a class="btn btn-sm btn-primary" href="<?php echo base_url();?>documents/fliedownload/<?php echo $row->file_name;?>" style="width:auto;text-decoration: none;"> 
              Download</a>
              ...
              <li>  <a href="<?php echo base_url()?>documents/edit/<?php echo $row->document_id;?>"><i class="fa fa-edit tiny-icon"></i>Edit</a></li>
                      <?php if($this->session->userdata('delete')=='YES'){ ?>
              <li><a href="<?php echo base_url()?>documents/delete/<?php echo $row->document_id;?>" class="delete"  onClick="return doconfirm();">
