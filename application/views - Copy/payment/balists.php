...
<a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>payment/budgeta/add">
...
<!-- /.box-header -->
<div class="box-body">
  <form class="form-horizontal" action="<?php echo base_url();?>payment/budgeta/lists" method="GET" enctype="multipart/form-data">
  <div class="box-body">
    <div class="form-group">
    <label class="col-sm-2 control-label">Budget. NO </label>
      <div class="col-sm-2">
        <input class="form-control" name="budgeta_no" id="budgeta_no" value="<?php echo set_value('budgeta_no'); ?>" placeholder="NO">
      <span class="error-msg"><?php echo form_error("budgeta_no");?></span>
      </div>
      <div class="form-group">
      ...
      <div class="col-sm-2">
        ...
        <a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>payment/budgeta/lists">All</a>
    </div>
  </div>
  </div>
  <!-- /.box-body -->
    ...
    <tr>
      ...
      <div class="btn-group">
        ...
        <ul class="dropdown-menu pull-right" role="menu">
          <li><a href="<?php echo base_url()?>payment/budgeta/view/<?php echo $row->master_id;?>">
        ...
        <?php if($row->status==1){ ?>
        <li> <a href="<?php echo base_url()?>payment/budgeta/submit/<?php echo $row->master_id;?>">
          <i class="fa fa-arrow-circle-o-right tiny-icon"></i>Submit</a></li>
        <li> <a href="<?php echo base_url()?>payment/budgeta/edit/<?php echo $row->master_id;?>">
          <i class="fa fa-edit tiny-icon"></i>Edit 编辑</a></li>
        <li><a href="#" class="delete" data-budgetad="<?php echo $row->master_id;?>">
...
$(".delete").click(function(e){
  job=confirm("Are you sure you want to delete this Inpaymention?");
   if(job==true){
  e.preventDefault();
  var rowId=$(this).data('budgetad');
  location.href="<?php echo base_url();?>payment/budgeta/deletes/"+rowId;
}else{
  return false;
}
});
