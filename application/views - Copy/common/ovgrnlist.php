...
<div class="widget-control pull-right">
            ...
            <!-- /.box-header -->
  <div class="box-body">
    <form class="form-horizontal" action="<?php echo base_url();?>common/ovgrn/lists" method="GET" enctype="multipart/form-data">
    ...
    <label class="col-sm-1 control-label">Search By </label>
        ...
        <div class="col-sm-2">
          ...
          <a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>common/ovgrn/lists">All</a>
      </div>
    </div>
        ...
        if($list&&!empty($list)): $i=$page+1;
          ...
          <tr>
            ...
            <div class="btn-group">
              ...
              <li> <a href="<?php echo base_url()?>common/ovgrn/view/<?php echo $row->purchase_id;?>" target="_blank"><i class="fa fa-eye tiny-icon"></i>View</a></li>
              <li> <a href="<?php echo base_url()?>common/ovgrn/viewpdf/<?php echo $row->purchase_id;?>" target="_blank"><i class="fa fa-eye tiny-icon"></i>PDF</a></li>
              <?php if($row->status==2){ ?>
              <li><a href="<?php echo base_url()?>common/ovgrn/received/<?php echo $row->purchase_id;?>"><i class="fa fa-arrow-circle-o-right tiny-icon"></i>Stock In</a></li>
              <li><a href="<?php echo base_url()?>common/ovgrn/returns/<?php echo $row->purchase_id;?>"><i class="fa fa-trash-o tiny-icon"></i>Return</a></li>
              <?php } ?>
             </ul>
            </div>
            </td>
