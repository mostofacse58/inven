...
<div class="widget-control pull-right">
   ...
   <div class="box box-info">
          <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>it/spares/save<?php if(isset($info)) echo "/$info->product_id"; ?>" method="POST" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <label class="col-sm-2 control-label">Tools/Materials Code<span style="color:red;">  *</span></label>
                  <div class="col-sm-4">
          ...
          <div class="form-group">
              ...
              <div class="box-footer">
                 <div class="col-sm-4"><a href="<?php echo base_url(); ?>it/spares/lists" class="btn btn-info"><i class="fa fa-arrow-circle-o-left" aria-hidden="true"></i> Back</a></div>
                 <div class="col-sm-4">
