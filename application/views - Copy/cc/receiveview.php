...
<div class="box-footer">
 ...
 <div class="col-sm-6">
  ...
  <a href="<?php echo base_url(); ?>cc/receive/received/<?php echo $info->courier_id; ?>" class="btn btn-info"> 
      <i class="fa fa-check" aria-hidden="true"></i> Receive</a>
 </div>
 <?php } ?>
  </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" id="formId" method="POST" action="<?php echo base_url()?>cc/receive/returns">
