...
<div class="box box-info">
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>cc/chargeback/save<?php if(isset($info)) echo "/$info->chargeback_id"; ?>" method="POST" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-2 control-label">Name<span style="color:red;">  *</span></label>
                  <div class="col-sm-3">
                    <input type="text" name="chargeback_name" class="form-control" placeholder=" Name" value="<?php if(isset($info->chargeback_name)) echo $info->chargeback_name; else echo set_value('chargeback_name'); ?>" autofocus>
                   <span class="error-msg"><?php echo form_error("chargeback_name");?></span>
                  </div>
                  <label class="col-sm-2 control-label">Description<span style="color:red;"> </span></label>
                  <div class="col-sm-3">
                    <textarea type="text" name="description" class="form-control" placeholder="Address" value=""><?php if(isset($info->description)) echo $info->description; else echo set_value('description'); ?></textarea>
                ...
                <thead>
                  ...
                  if($list&&!empty($list)):
                      foreach($list as $row):
                          ?>
                      <tr>
                        <td><?php echo $row->chargeback_name;?></td>
