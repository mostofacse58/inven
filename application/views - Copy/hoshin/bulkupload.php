<div class="row">
    <div class="col-md-12">
      <div class="box box-info">
        <!-- /.box-header -->
        <!-- form start -->
        <form class="form-horizontal" action="<?php echo base_url(); ?>hoshin/actions/savebulk" method="POST" enctype="multipart/form-data" onsubmit="return formsubmit();">
      <div class="box-body">
  ...
  <div class="box-footer">
      <div class="col-sm-4"><a href="<?php echo base_url(); ?>hoshin/actions/lists" class="btn btn-info">
