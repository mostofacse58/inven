...
<p style="line-height: 20px;padding: 0px 5px;font-size: 18px" >
  <b>Purchase Indent(<?php if($info->pi_type==1) echo "Safety Stock"; else echo "Fixed Asset"; ?>) <br>物料申购单 </b></p>
</div>
...
<table class="tg1" style="overflow: hidden;">
  ...
  <div class="col-sm-4">
    <a href="<?php echo base_url(); ?>format/<?php echo $controller; ?>/lists" class="btn btn-info">
