...
<div class="widget-control pull-right">
   ...
   <div class="box box-info">
          <!-- /.box-header -->
      <form class="form-horizontal" action="<?php echo base_url();?>documents/save<?php if(isset($info)) echo "/$info->document_id"; ?>" method="POST" enctype="multipart/form-data">
          <div class="box-body">
             ...
             <div class="col-sm-5">
              ...
              <?php if (isset($info->file_name) && !empty($info->file_name)) { ?>
                <div style="margin-top:20px;">
                  <a href="<?php echo base_url();?>documents/fliedownload/<?php echo $info->file_name;?>" style="width:auto;text-decoration: none;">                 
        ...
        <div class="box-footer">
           <div class="col-sm-4"><a href="<?php echo base_url(); ?>documents/lists" class="btn btn-info">
