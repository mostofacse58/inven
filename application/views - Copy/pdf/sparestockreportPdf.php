...
<table class="tg">
   <thead>
    <tr>
          ...
          <th style="text-align:center;width:5%">Stock Value(HKD) <br>库存金额</th>
    ...
    <?php 
      ...
      if(isset($resultdetail)&&!empty($resultdetail)): $i=1;
        foreach($resultdetail as $row):
          ...
          $color="background-color: white;color: #000;";
            if($stock<($row->minimum_stock-$row->avg_use_per_month)){
          ...
          <tr>
            ...
            <td style="vertical-align: text-top;text-align:center;<?php echo $color; ?>">
            <?php  echo ceil($row->minimum_stock-$row->avg_use_per_month); ?></td>
            <td style="vertical-align: text-top;text-align:center;<?php echo $color; ?>">
      ...
      ?>
      <tr>
          <th style="text-align:right;" colspan="21">Grand Total</th>
