...
<div class="box-footer">
   <div class="col-sm-6">
    <a href="<?php echo base_url(); ?>gatep/checkgatepass/lists" class="btn btn-info"> <i class="fa fa-arrow-circle-o-left" aria-hidden="true"></i> Back</a>
 ...
 <div class="col-sm-6">
  ...
  <a href="<?php echo base_url(); ?>gatep/checkgatepass/approved/<?php echo $info->gatepass_id; ?>" class="btn btn-info"> 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" id="formId" method="POST" action="<?php echo base_url()?>gatep/checkgatepass/returns">
