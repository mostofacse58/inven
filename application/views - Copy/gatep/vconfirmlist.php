...
var url1="<?php echo base_url(); ?>gatep/vconfirm/lists";
...
<div class="widget-control pull-right">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form class="form-horizontal" action="<?php echo base_url();?>gatep/vconfirm/lists" method="GET" enctype="multipart/form-data">
                ...
                <div class="col-sm-1">
                  <a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>gatep/vconfirm/lists">All</a>
                </div>
                </div>
              </form>
          ...
          if($list&&!empty($list)): $i=1;
            ...
            <td style="text-align:center">
              <span class="btn btn-xs btn-<?php echo ($row->gatepass_status==2)?"danger":"success";?>">
                  <?php 
                  if($row->gatepass_status==1) echo "Draft";
                  elseif($row->gatepass_status==2) echo "Pending";
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu pull-right" role="menu">
                      <li><a href="<?php echo base_url()?>gatep/vconfirm/view/<?php echo $row->gatepass_id;?>"><i class="fa ffa fa-eye tiny-icon"></i>View</a></li>
                       <?php if($row->gatepass_status==2){  ?>
                     <li><a href="<?php echo base_url()?>gatep/vconfirm/viewapproved/<?php echo $row->gatepass_id;?>">
                      <i class="fa fa-arrow-circle-right tiny-icon"></i>View & Confirm</a></li>
                    <?php } ?>
                    </ul>
                </div>
                </td>
 ...
 <div class="modal modal-danger fade bs-example-modal-sm " tabindex="-1" role="dialog" id="deleteMessage" aria-labelledby="mySmallModalLabel">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" id="formId" method="POST" action="<?php echo base_url()?>gatep/vconfirm/decline">
          <div class="form-group">
