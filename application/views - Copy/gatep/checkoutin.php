  ...
  var url1="<?php echo base_url(); ?>gatep/checkout/lists2";
...
<div class="box-footer">
   <div class="col-sm-6">
    <a href="<?php echo base_url(); ?>gatep/checkout/lists2" class="btn btn-info"> <i class="fa fa-arrow-circle-o-left" aria-hidden="true"></i> Back</a>
   <button class="btn btn-info prints"><i class="fa fa-print" ></i> Print</button>
 </div>
 <?php if($info->gatepass_status==5){  ?>
 <div class="col-sm-6">
  <a href="<?php echo base_url(); ?>gatep/checkout/approved2/<?php echo $info->gatepass_id; ?>" class="btn btn-info"> 
   <i class="fa fa-check" aria-hidden="true"></i> Checkin</a>
 </div>
 <?php } ?>
  </div>
