...
<a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>gatep/checkout/searchInForm">
...
Scan Code
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form class="form-horizontal" action="<?php echo base_url();?>gatep/checkout/lists2" method="GET" enctype="multipart/form-data">
                ...
                <div class="col-sm-1">
                  <a class="btn btn-sm btn-primary pull-right" style="margin-right:0px;" href="<?php echo base_url(); ?>gatep/checkout/lists2">All</a>
                </div>
                </div>
              </form>
              ...
              <span class="btn btn-xs btn-<?php echo ($row->gatepass_status==5)?"danger":"success";?>">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu pull-right" role="menu">
                      <li><a href="<?php echo base_url()?>gatep/checkout/view2/<?php echo $row->gatepass_id;?>"><i class="fa fa-eye tiny-icon"></i>View</a></li>
                       <?php if($row->gatepass_status==5){  ?>
                     <li><a href="<?php echo base_url()?>gatep/checkout/viewapproved2/<?php echo $row->gatepass_id;?>"><i class="fa fa-arrow-circle-right tiny-icon"></i>View & Checkout</a></li>
                    <?php } ?>
                    </ul>
                </div>
                </td>
