...
-- /////////////////////
DELETE FROM  stock_master_detail WHERE FIFO_CODE='2402031616460001' AND product_id=863;
DELETE FROM  item_issue_detail WHERE FIFO_CODE='2402031616460001' AND product_id=863;
DELETE FROM  purchase_detail WHERE FIFO_CODE='2402031616460001' AND product_id=863; 
DELETE FROM  spares_use_detail WHERE FIFO_CODE='2402031616460001' AND product_id=863;


DELETE FROM  stock_master_detail WHERE FIFO_CODE='2402031616460001';
DELETE FROM  item_issue_detail WHERE FIFO_CODE='2402031616460001';
DELETE FROM  purchase_detail WHERE FIFO_CODE='2402031616460001'; 
DELETE FROM  spares_use_detail WHERE FIFO_CODE='2402031616460001';
